...
import style from "../privacy-policy/style.module.css";
        ...
        <div className={style.wrapper}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to eliasnorta.com.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to eliasnorta.com, accessible
                from{" "}
                <a
                  href="https://www.eliasnorta.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.eliasnorta.com
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              <a
                href="https://eliasnorta.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://eliasnorta.com
              </a>
            </li>
          </ul>
        </div>
